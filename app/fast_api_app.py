...
try:
    ...
    logger.warning(
        f"Google Cloud Logging initialization failed: {e}. Falling back to standard Python logging."
    )
...
app.title = "aegis-monkey"
app.description = "API for interacting with the Agent aegis-monkey"
